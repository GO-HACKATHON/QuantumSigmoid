...
$config['assets']	= 'http://'.$_SERVER['HTTP_HOST']."/".$app."/assets";

$config['bootstrap']	= 'http://'.$_SERVER['HTTP_HOST']."/".$app."/assets/".$bs;
$config['highcharts']	= 'http://'.$_SERVER['HTTP_HOST']."/".$app."/assets/highcharts/";
